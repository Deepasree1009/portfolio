...
sr.reveal('.heading', {distance: '20px', delay: 50, interval: 100});
sr.reveal('.hex-row', {distance: '30px', delay: 50, interval: 100});

// sr.reveal('.hex-row', {delay: 400});

sr.reveal('.portfolio-img', {interval: 200});
sr.reveal('.flip-card', {interval: 200});
